	...
	render() {
		...
		return (
			<div className={styles.Styleguide}>
				<div id="StyleguideSidebar" ref="scrollit" className={styles.StyleguideSidebar + ' ' + styles.secondaryColumn + ' ' + (this.state.isScrolled ? styles.isScrolled : styles.notScrolled)}>
					<div className={styles.listTitle}>
						<h4>Components</h4>
					</div>
					<ul className={styles.StyleguideSidebarList}>
