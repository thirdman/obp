		...
		if (token && token.myob && token.myob.connectedAt) {
			return (
				<div>
					...
					<Message type="success" content="Successfully connected to FreshBooks" />
					<Section title={'What next?'} description={'Now that you have connected your FreshBooks account, there\'s some things to check'}>
						<ol>
							<li>
		...
		if (!doneAuth) {
			return (
				<div>
					...
					<Button
						content={connecting ? 'Loading ... ' : 'Connect to FreshBooks'}
